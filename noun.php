	...
	<body>
		<?php
			...
			if(endsWith($pp2, "ae") || endsWith($pp2, "arum")) {
				$decl = 1;
			} else if(endsWith($pp2, "i") || endsWith($pp2, "orum")) {
				$decl = 2;
			} else if(endsWith($pp2, "is") || (endsWith($pp2, "um") && (endsWith($pp1, "es") || endsWith($pp1, "a")))) {
				$decl = 3;
			} else if(endsWith($pp2, "us") || endsWith($pp2, "um")) {
				$decl = 4;
			} else {
				die("Unable to determine declension ID due to invalid, or 5th declension genitive ending.");
			}
			...
			if($decl == 1) {
				...
				$dat1 = $stem . "o";
				$abl1 = $dat1;
				$voc1 = ($pp3 == "m" && endsWith($pp1, "us") && !endsWith($pp1, "ius") ? $stem . "e" : $pp1);
				...
				$ex4 = $pp1 == "frater" || $pp1 == "mater" || $pp1 == "pater" || $pp1 == "canis" || $pp1 == "senex" || $pp1 == "juvenis";
